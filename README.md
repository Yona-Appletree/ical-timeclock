...
2. Create a bookmarklet with this code: `javascript:$.ajax('//raw.githubusercontent.com/Yona-Appletree/ical-timeclock/master/ical-timeclock.js?cb'+Math.random()).done(c=>eval(c))`
